...
`)+`
`+h);const E=b+d+a,T=b+h+o,k=Ka(r,r.VERTEX_SHADER,E),R=Ka(r,r.FRAGMENT_SHADER,T);r.attachShader(M,k),r.attachShader(M,R),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function A(S){if(i.debug.checkShaderErrors){const z=r.getProgramInfoLog(M).trim(),B=r.getShaderInfoLog(k).trim(),X=r.getShaderInfoLog(R).trim();let $=!0,H=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,k,R);else{const J=$a(r,k,"vertex"),V=$a(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`;function ep(i,e,t){let n=new Yo;const r=new je,s=new je,a=new it,o=new $f({depthPacking:Wl}),l=new Zf,c={},u=t.maxTextureSize,f={[pn]:xt,[xt]:pn,[$t]:$t},p=new kt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:Jf,fragmentShader:Qf}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const v=new zt;v.setAttribute("position",new vt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Qt(v,p),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Eo;let h=this.type;this.render=function(R,A,O){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||R.length===0)return;const Q=i.getRenderTarget(),g=i.getActiveCubeFace(),S=i.getActiveMipmapLevel(),z=i.state;z.setBlending(dn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const B=h!==Kt&&this.type===Kt,X=h===Kt&&this.type!==Kt;for(let $=0,H=R.length;$<H;$++){const J=R[$],V=J.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const se=V.getFrameExtents();if(r.multiply(se),s.copy(V.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/se.x),r.x=s.x*se.x,V.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/se.y),r.y=s.y*se.y,V.mapSize.y=s.y)),V.map===null||B===!0||X===!0){const D=this.type!==Kt?{minFilter:Pt,magFilter:Pt}:{};V.map!==null&&V.map.dispose(),V.map=new Pn(r.x,r.y,D),V.map.texture.name=J.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const le=V.getViewportCount();for(let D=0;D<le;D++){const ie=V.getViewport(D);a.set(s.x*ie.x,s.y*ie.y,s.x*ie.z,s.y*ie.w),z.viewport(a),V.updateMatrices(J,D),n=V.getFrustum(),T(A,O,V.camera,J,this.type)}V.isPointLightShadow!==!0&&this.type===Kt&&b(V,O),V.needsUpdate=!1}h=this.type,d.needsUpdate=!1,i.setRenderTarget(Q,g,S)};function b(R,A){const O=e.update(M);p.defines.VSM_SAMPLES!==R.blurSamples&&(p.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Pn(r.x,r.y)),p.uniforms.shadow_pass.value=R.map.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(A,null,O,p,M,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(A,null,O,m,M,null)}function E(R,A,O,Q){let g=null;const S=O.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(S!==void 0)g=S;else if(g=O.isPointLight===!0?l:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const z=g.uuid,B=A.uuid;let X=c[z];X===void 0&&(X={},c[z]=X);let $=X[B];$===void 0&&($=g.clone(),X[B]=$,A.addEventListener("dispose",k)),g=$}if(g.visible=A.visible,g.wireframe=A.wireframe,Q===Kt?g.side=A.shadowSide!==null?A.shadowSide:A.side:g.side=A.shadowSide!==null?A.shadowSide:f[A.side],g.alphaMap=A.alphaMap,g.alphaTest=A.alphaTest,g.map=A.map,g.clipShadows=A.clipShadows,g.clippingPlanes=A.clippingPlanes,g.clipIntersection=A.clipIntersection,g.displacementMap=A.displacementMap,g.displacementScale=A.displacementScale,g.displacementBias=A.displacementBias,g.wireframeLinewidth=A.wireframeLinewidth,g.linewidth=A.linewidth,O.isPointLight===!0&&g.isMeshDistanceMaterial===!0){const z=i.properties.get(g);z.light=O}return g}function T(R,A,O,Q,g){if(R.visible===!1)return;if(R.layers.test(A.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&g===Kt)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,R.matrixWorld);const B=e.update(R),X=R.material;if(Array.isArray(X)){const $=B.groups;for(let H=0,J=$.length;H<J;H++){const V=$[H],se=X[V.materialIndex];if(se&&se.visible){const le=E(R,se,Q,g);R.onBeforeShadow(i,R,A,O,B,le,V),i.renderBufferDirect(O,null,B,le,R,V),R.onAfterShadow(i,R,A,O,B,le,V)}}}else if(X.visible){const $=E(R,X,Q,g);R.onBeforeShadow(i,R,A,O,B,$,null),i.renderBufferDirect(O,null,B,$,R,null),R.onAfterShadow(i,R,A,O,B,$,null)}}const z=R.children;for(let B=0,X=z.length;B<X;B++)T(z[B],A,O,Q,g)}function k(R){R.target.removeEventListener("dispose",k);for(const O in c){const Q=c[O],g=R.target.uuid;g in Q&&(Q[g].dispose(),delete Q[g])}}}const tp={[ns]:is,[rs]:os,[ss]:ls,[$n]:as,[is]:ns,[os]:rs,[ls]:ss,[as]:$n};function np(i){function e(){let C=!1;const de=new it;let W=null;const j=new it(0,0,0,0);return{setMask:function(ue){W!==ue&&!C&&(i.colorMask(ue,ue,ue,ue),W=ue)},setLocked:function(ue){C=ue},setClear:function(ue,fe,Be,rt,pt){pt===!0&&(ue*=rt,fe*=rt,Be*=rt),de.set(ue,fe,Be,rt),j.equals(de)===!1&&(i.clearColor(ue,fe,Be,rt),j.copy(de))},reset:function(){C=!1,W=null,j.set(-1,0,0,0)}}}function t(){let C=!1,de=!1,W=null,j=null,ue=null;return{setReversed:function(fe){de=fe},setTest:function(fe){fe?ce(i.DEPTH_TEST):ee(i.DEPTH_TEST)},setMask:function(fe){W!==fe&&!C&&(i.depthMask(fe),W=fe)},setFunc:function(fe){if(de&&(fe=tp[fe]),j!==fe){switch(fe){case ns:i.depthFunc(i.NEVER);break;case is:i.depthFunc(i.ALWAYS);break;case rs:i.depthFunc(i.LESS);break;case $n:i.depthFunc(i.LEQUAL);break;case ss:i.depthFunc(i.EQUAL);break;case as:i.depthFunc(i.GEQUAL);break;case os:i.depthFunc(i.GREATER);break;case ls:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}j=fe}},setLocked:function(fe){C=fe},setClear:function(fe){ue!==fe&&(i.clearDepth(fe),ue=fe)},reset:function(){C=!1,W=null,j=null,ue=null}}}function n(){let C=!1,de=null,W=null,j=null,ue=null,fe=null,Be=null,rt=null,pt=null;return{setTest:function(ke){C||(ke?ce(i.STENCIL_TEST):ee(i.STENCIL_TEST))},setMask:function(ke){de!==ke&&!C&&(i.stencilMask(ke),de=ke)},setFunc:function(ke,mt,Vt){(W!==ke||j!==mt||ue!==Vt)&&(i.stencilFunc(ke,mt,Vt),W=ke,j=mt,ue=Vt)},setOp:function(ke,mt,Vt){(fe!==ke||Be!==mt||rt!==Vt)&&(i.stencilOp(ke,mt,Vt),fe=ke,Be=mt,rt=Vt)},setLocked:function(ke){C=ke},setClear:function(ke){pt!==ke&&(i.clearStencil(ke),pt=ke)},reset:function(){C=!1,de=null,W=null,j=null,ue=null,fe=null,Be=null,rt=null,pt=null}}}const r=new e,s=new t,a=new n,o=new WeakMap,l=new WeakMap;let c={},u={},f=new WeakMap,p=[],m=null,v=!1,M=null,d=null,h=null,b=null,E=null,T=null,k=null,R=new Ge(0,0,0),A=0,O=!1,Q=null,g=null,S=null,z=null,B=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,H=0;const J=i.getParameter(i.VERSION);J.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(J)[1]),$=H>=1):J.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),$=H>=2);let V=null,se={};const le=i.getParameter(i.SCISSOR_BOX),D=i.getParameter(i.VIEWPORT),ie=new it().fromArray(le),_e=new it().fromArray(D);function G(C,de,W,j){const ue=new Uint8Array(4),fe=i.createTexture();i.bindTexture(C,fe),i.texParameteri(C,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(C,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Be=0;Be<W;Be++)C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY?i.texImage3D(de,0,i.RGBA,1,1,j,0,i.RGBA,i.UNSIGNED_BYTE,ue):i.texImage2D(de+Be,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ue);return fe}const K={};K[i.TEXTURE_2D]=G(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=G(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=G(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=G(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),a.setClear(0),ce(i.DEPTH_TEST),s.setFunc($n),Ne(!1),ze(da),ce(i.CULL_FACE),w(dn);function ce(C){c[C]!==!0&&(i.enable(C),c[C]=!0)}function ee(C){c[C]!==!1&&(i.disable(C),c[C]=!1)}function ye(C,de){return u[C]!==de?(i.bindFramebuffer(C,de),u[C]=de,C===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=de),C===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=de),!0):!1}function Te(C,de){let W=p,j=!1;if(C){W=f.get(de),W===void 0&&(W=[],f.set(de,W));const ue=C.textures;if(W.length!==ue.length||W[0]!==i.COLOR_ATTACHMENT0){for(let fe=0,Be=ue.length;fe<Be;fe++)W[fe]=i.COLOR_ATTACHMENT0+fe;W.length=ue.length,j=!0}}else W[0]!==i.BACK&&(W[0]=i.BACK,j=!0);j&&i.drawBuffers(W)}function Ie(C){return m!==C?(i.useProgram(C),m=C,!0):!1}const Ye={[bn]:i.FUNC_ADD,[gl]:i.FUNC_SUBTRACT,[_l]:i.FUNC_REVERSE_SUBTRACT};Ye[vl]=i.MIN,Ye[xl]=i.MAX;const Oe={[Ml]:i.ZERO,[Sl]:i.ONE,[El]:i.SRC_COLOR,[es]:i.SRC_ALPHA,[Rl]:i.SRC_ALPHA_SATURATE,[Al]:i.DST_COLOR,[Tl]:i.DST_ALPHA,[yl]:i.ONE_MINUS_SRC_COLOR,[ts]:i.ONE_MINUS_SRC_ALPHA,[wl]:i.ONE_MINUS_DST_COLOR,[bl]:i.ONE_MINUS_DST_ALPHA,[Cl]:i.CONSTANT_COLOR,[Pl]:i.ONE_MINUS_CONSTANT_COLOR,[Ll]:i.CONSTANT_ALPHA,[Dl]:i.ONE_MINUS_CONSTANT_ALPHA};function w(C,de,W,j,ue,fe,Be,rt,pt,ke){if(C===dn){v===!0&&(ee(i.BLEND),v=!1);return}if(v===!1&&(ce(i.BLEND),v=!0),C!==ml){if(C!==M||ke!==O){if((d!==bn||E!==bn)&&(i.blendEquation(i.FUNC_ADD),d=bn,E=bn),ke)switch(C){case Yn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case rr:i.blendFunc(i.ONE,i.ONE);break;case fa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case pa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}else switch(C){case Yn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case rr:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case fa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case pa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}h=null,b=null,T=null,k=null,R.set(0,0,0),A=0,M=C,O=ke}return}ue=ue||de,fe=fe||W,Be=Be||j,(de!==d||ue!==E)&&(i.blendEquationSeparate(Ye[de],Ye[ue]),d=de,E=ue),(W!==h||j!==b||fe!==T||Be!==k)&&(i.blendFuncSeparate(Oe[W],Oe[j],Oe[fe],Oe[Be]),h=W,b=j,T=fe,k=Be),(rt.equals(R)===!1||pt!==A)&&(i.blendColor(rt.r,rt.g,rt.b,pt),R.copy(rt),A=pt),M=C,O=!1}function St(C,de){C.side===$t?ee(i.CULL_FACE):ce(i.CULL_FACE);let W=C.side===xt;de&&(W=!W),Ne(W),C.blending===Yn&&C.transparent===!1?w(dn):w(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.blendColor,C.blendAlpha,C.premultipliedAlpha),s.setFunc(C.depthFunc),s.setTest(C.depthTest),s.setMask(C.depthWrite),r.setMask(C.colorWrite);const j=C.stencilWrite;a.setTest(j),j&&(a.setMask(C.stencilWriteMask),a.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),a.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),$e(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?ce(i.SAMPLE_ALPHA_TO_COVERAGE):ee(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ne(C){Q!==C&&(C?i.frontFace(i.CW):i.frontFace(i.CCW),Q=C)}function ze(C){C!==dl?(ce(i.CULL_FACE),C!==g&&(C===da?i.cullFace(i.BACK):C===fl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ee(i.CULL_FACE),g=C}function we(C){C!==S&&($&&i.lineWidth(C),S=C)}function $e(C,de,W){C?(ce(i.POLYGON_OFFSET_FILL),(z!==de||B!==W)&&(i.polygonOffset(de,W),z=de,B=W)):ee(i.POLYGON_OFFSET_FILL)}function Pe(C){C?ce(i.SCISSOR_TEST):ee(i.SCISSOR_TEST)}function y(C){C===void 0&&(C=i.TEXTURE0+X-1),V!==C&&(i.activeTexture(C),V=C)}function _(C,de,W){W===void 0&&(V===null?W=i.TEXTURE0+X-1:W=V);let j=se[W];j===void 0&&(j={type:void 0,texture:void 0},se[W]=j),(j.type!==C||j.texture!==de)&&(V!==W&&(i.activeTexture(W),V=W),i.bindTexture(C,de||K[C]),j.type=C,j.texture=de)}function U(){const C=se[V];C!==void 0&&C.type!==void 0&&(i.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function Y(){try{i.compressedTexImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function q(){try{i.texSubImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Me(){try{i.texSubImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function oe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function pe(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function He(){try{i.texStorage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function te(){try{i.texStorage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function me(){try{i.texImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Re(){try{i.texImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Ce(C){ie.equals(C)===!1&&(i.scissor(C.x,C.y,C.z,C.w),ie.copy(C))}function ge(C){_e.equals(C)===!1&&(i.viewport(C.x,C.y,C.z,C.w),_e.copy(C))}function Fe(C,de){let W=l.get(de);W===void 0&&(W=new WeakMap,l.set(de,W));let j=W.get(C);j===void 0&&(j=i.getUniformBlockIndex(de,C.name),W.set(C,j))}function Le(C,de){const j=l.get(de).get(C);o.get(de)!==j&&(i.uniformBlockBinding(de,j,C.__bindingPointIndex),o.set(de,j))}function Ke(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},V=null,se={},u={},f=new WeakMap,p=[],m=null,v=!1,M=null,d=null,h=null,b=null,E=null,T=null,k=null,R=new Ge(0,0,0),A=0,O=!1,Q=null,g=null,S=null,z=null,B=null,ie.set(0,0,i.canvas.width,i.canvas.height),_e.set(0,0,i.canvas.width,i.canvas.height),r.reset(),s.reset(),a.reset()}return{buffers:{color:r,depth:s,stencil:a},enable:ce,disable:ee,bindFramebuffer:ye,drawBuffers:Te,useProgram:Ie,setBlending:w,setMaterial:St,setFlipSided:Ne,setCullFace:ze,setLineWidth:we,setPolygonOffset:$e,setScissorTest:Pe,activeTexture:y,bindTexture:_,unbindTexture:U,compressedTexImage2D:Y,compressedTexImage3D:Z,texImage2D:me,texImage3D:Re,updateUBOMapping:Fe,uniformBlockBinding:Le,texStorage2D:He,texStorage3D:te,texSubImage2D:q,texSubImage3D:Me,compressedTexSubImage2D:oe,compressedTexSubImage3D:pe,scissor:Ce,viewport:ge,reset:Ke}}function ro(i,e,t,n){const r=ip(n);switch(t){case Ro:return i*e;case Po:return i*e;case Lo:return i*e*2;case Do:return i*e/r.components*r.byteLength;case js:return i*e/r.components*r.byteLength;case Uo:return i*e*2/r.components*r.byteLength;case Ks:return i*e*2/r.components*r.byteLength;case Co:return i*e*3/r.components*r.byteLength;case Bt:return i*e*4/r.components*r.byteLength;case $s:return i*e*4/r.components*r.byteLength;case Zi:case Ji:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Qi:case er:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case ps:case gs:return Math.max(i,16)*Math.max(e,8)/4;case fs:case ms:return Math.max(i,8)*Math.max(e,8)/2;case _s:case vs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case xs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ms:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ss:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case Es:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case ys:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Ts:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case bs:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case As:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case ws:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Rs:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Cs:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case Ps:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Ls:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Ds:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Us:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case tr:case Is:case Ns:return Math.ceil(i/4)*Math.ceil(e/4)*16;case Io:case Fs:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Os:case Bs:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function ip(i){switch(i){case tn:case bo:return{byteLength:1,components:1};case mi:case Ao:case gi:return{byteLength:2,components:1};case qs:case Ys:return{byteLength:2,components:4};case Cn:case Xs:case Zt:return{byteLength:4,components:1};case wo:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function rp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new je,u=new WeakMap;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(y,_){return m?new OffscreenCanvas(y,_):cr("canvas")}function M(y,_,U){let Y=1;const Z=Pe(y);if((Z.width>U||Z.height>U)&&(Y=U/Math.max(Z.width,Z.height)),Y<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const q=Math.floor(Y*Z.width),Me=Math.floor(Y*Z.height);f===void 0&&(f=v(q,Me));const oe=_?v(q,Me):f;return oe.width=q,oe.height=Me,oe.getContext("2d").drawImage(y,0,0,q,Me),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+q+"x"+Me+")."),oe}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),y;return y}function d(y){return y.generateMipmaps&&y.minFilter!==Pt&&y.minFilter!==Ft}function h(y){i.generateMipmap(y)}function b(y,_,U,Y,Z=!1){if(y!==null){if(i[y]!==void 0)return i[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let q=_;if(_===i.RED&&(U===i.FLOAT&&(q=i.R32F),U===i.HALF_FLOAT&&(q=i.R16F),U===i.UNSIGNED_BYTE&&(q=i.R8)),_===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&(q=i.R8UI),U===i.UNSIGNED_SHORT&&(q=i.R16UI),U===i.UNSIGNED_INT&&(q=i.R32UI),U===i.BYTE&&(q=i.R8I),U===i.SHORT&&(q=i.R16I),U===i.INT&&(q=i.R32I)),_===i.RG&&(U===i.FLOAT&&(q=i.RG32F),U===i.HALF_FLOAT&&(q=i.RG16F),U===i.UNSIGNED_BYTE&&(q=i.RG8)),_===i.RG_INTEGER&&(U===i.UNSIGNED_BYTE&&(q=i.RG8UI),U===i.UNSIGNED_SHORT&&(q=i.RG16UI),U===i.UNSIGNED_INT&&(q=i.RG32UI),U===i.BYTE&&(q=i.RG8I),U===i.SHORT&&(q=i.RG16I),U===i.INT&&(q=i.RG32I)),_===i.RGB_INTEGER&&(U===i.UNSIGNED_BYTE&&(q=i.RGB8UI),U===i.UNSIGNED_SHORT&&(q=i.RGB16UI),U===i.UNSIGNED_INT&&(q=i.RGB32UI),U===i.BYTE&&(q=i.RGB8I),U===i.SHORT&&(q=i.RGB16I),U===i.INT&&(q=i.RGB32I)),_===i.RGBA_INTEGER&&(U===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),U===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),U===i.UNSIGNED_INT&&(q=i.RGBA32UI),U===i.BYTE&&(q=i.RGBA8I),U===i.SHORT&&(q=i.RGBA16I),U===i.INT&&(q=i.RGBA32I)),_===i.RGB&&U===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),_===i.RGBA){const Me=Z?sr:Xe.getTransfer(Y);U===i.FLOAT&&(q=i.RGBA32F),U===i.HALF_FLOAT&&(q=i.RGBA16F),U===i.UNSIGNED_BYTE&&(q=Me===Je?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function E(y,_){let U;return y?_===null||_===Cn||_===Qn?U=i.DEPTH24_STENCIL8:_===Zt?U=i.DEPTH32F_STENCIL8:_===mi&&(U=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Cn||_===Qn?U=i.DEPTH_COMPONENT24:_===Zt?U=i.DEPTH_COMPONENT32F:_===mi&&(U=i.DEPTH_COMPONENT16),U}function T(y,_){return d(y)===!0||y.isFramebufferTexture&&y.minFilter!==Pt&&y.minFilter!==Ft?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function k(y){const _=y.target;_.removeEventListener("dispose",k),A(_),_.isVideoTexture&&u.delete(_)}function R(y){const _=y.target;_.removeEventListener("dispose",R),Q(_)}function A(y){const _=n.get(y);if(_.__webglInit===void 0)return;const U=y.source,Y=p.get(U);if(Y){const Z=Y[_.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&O(y),Object.keys(Y).length===0&&p.delete(U)}n.remove(y)}function O(y){const _=n.get(y);i.deleteTexture(_.__webglTexture);const U=y.source,Y=p.get(U);delete Y[_.__cacheKey],a.memory.textures--}function Q(y){const _=n.get(y);if(y.depthTexture&&y.depthTexture.dispose(),y.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(_.__webglFramebuffer[Y]))for(let Z=0;Z<_.__webglFramebuffer[Y].length;Z++)i.deleteFramebuffer(_.__webglFramebuffer[Y][Z]);else i.deleteFramebuffer(_.__webglFramebuffer[Y]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[Y])}else{if(Array.isArray(_.__webglFramebuffer))for(let Y=0;Y<_.__webglFramebuffer.length;Y++)i.deleteFramebuffer(_.__webglFramebuffer[Y]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let Y=0;Y<_.__webglColorRenderbuffer.length;Y++)_.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[Y]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const U=y.textures;for(let Y=0,Z=U.length;Y<Z;Y++){const q=n.get(U[Y]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(U[Y])}n.remove(y)}let g=0;function S(){g=0}function z(){const y=g;return y>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),g+=1,y}function B(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function X(y,_){const U=n.get(y);if(y.isVideoTexture&&we(y),y.isRenderTargetTexture===!1&&y.version>0&&U.__version!==y.version){const Y=y.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{_e(U,y,_);return}}t.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+_)}function $(y,_){const U=n.get(y);if(y.version>0&&U.__version!==y.version){_e(U,y,_);return}t.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+_)}function H(y,_){const U=n.get(y);if(y.version>0&&U.__version!==y.version){_e(U,y,_);return}t.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+_)}function J(y,_){const U=n.get(y);if(y.version>0&&U.__version!==y.version){G(U,y,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+_)}const V={[hs]:i.REPEAT,[wn]:i.CLAMP_TO_EDGE,[ds]:i.MIRRORED_REPEAT},se={[Pt]:i.NEAREST,[kl]:i.NEAREST_MIPMAP_NEAREST,[bi]:i.NEAREST_MIPMAP_LINEAR,[Ft]:i.LINEAR,[Er]:i.LINEAR_MIPMAP_NEAREST,[Rn]:i.LINEAR_MIPMAP_LINEAR},le={[Yl]:i.NEVER,[Ql]:i.ALWAYS,[jl]:i.LESS,[No]:i.LEQUAL,[Kl]:i.EQUAL,[Jl]:i.GEQUAL,[$l]:i.GREATER,[Zl]:i.NOTEQUAL};function D(y,_){if(_.type===Zt&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ft||_.magFilter===Er||_.magFilter===bi||_.magFilter===Rn||_.minFilter===Ft||_.minFilter===Er||_.minFilter===bi||_.minFilter===Rn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,V[_.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,V[_.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,V[_.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,se[_.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,se[_.minFilter]),_.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,le[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Pt||_.minFilter!==bi&&_.minFilter!==Rn||_.type===Zt&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ie(y,_){let U=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",k));const Y=_.source;let Z=p.get(Y);Z===void 0&&(Z={},p.set(Y,Z));const q=B(_);if(q!==y.__cacheKey){Z[q]===void 0&&(Z[q]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,U=!0),Z[q].usedTimes++;const Me=Z[y.__cacheKey];Me!==void 0&&(Z[y.__cacheKey].usedTimes--,Me.usedTimes===0&&O(_)),y.__cacheKey=q,y.__webglTexture=Z[q].texture}return U}function _e(y,_,U){let Y=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Y=i.TEXTURE_3D);const Z=ie(y,_),q=_.source;t.bindTexture(Y,y.__webglTexture,i.TEXTURE0+U);const Me=n.get(q);if(q.version!==Me.__version||Z===!0){t.activeTexture(i.TEXTURE0+U);const oe=Xe.getPrimaries(Xe.workingColorSpace),pe=_.colorSpace===hn?null:Xe.getPrimaries(_.colorSpace),He=_.colorSpace===hn||oe===pe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,He);let te=M(_.image,!1,r.maxTextureSize);te=$e(_,te);const me=s.convert(_.format,_.colorSpace),Re=s.convert(_.type);let Ce=b(_.internalFormat,me,Re,_.colorSpace,_.isVideoTexture);D(Y,_);let ge;const Fe=_.mipmaps,Le=_.isVideoTexture!==!0,Ke=Me.__version===void 0||Z===!0,C=q.dataReady,de=T(_,te);if(_.isDepthTexture)Ce=E(_.format===ei,_.type),Ke&&(Le?t.texStorage2D(i.TEXTURE_2D,1,Ce,te.width,te.height):t.texImage2D(i.TEXTURE_2D,0,Ce,te.width,te.height,0,me,Re,null));else if(_.isDataTexture)if(Fe.length>0){Le&&Ke&&t.texStorage2D(i.TEXTURE_2D,de,Ce,Fe[0].width,Fe[0].height);for(let W=0,j=Fe.length;W<j;W++)ge=Fe[W],Le?C&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,ge.width,ge.height,me,Re,ge.data):t.texImage2D(i.TEXTURE_2D,W,Ce,ge.width,ge.height,0,me,Re,ge.data);_.generateMipmaps=!1}else Le?(Ke&&t.texStorage2D(i.TEXTURE_2D,de,Ce,te.width,te.height),C&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,te.width,te.height,me,Re,te.data)):t.texImage2D(i.TEXTURE_2D,0,Ce,te.width,te.height,0,me,Re,te.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Le&&Ke&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,Ce,Fe[0].width,Fe[0].height,te.depth);for(let W=0,j=Fe.length;W<j;W++)if(ge=Fe[W],_.format!==Bt)if(me!==null)if(Le){if(C)if(_.layerUpdates.size>0){const ue=ro(ge.width,ge.height,_.format,_.type);for(const fe of _.layerUpdates){const Be=ge.data.subarray(fe*ue/ge.data.BYTES_PER_ELEMENT,(fe+1)*ue/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,fe,ge.width,ge.height,1,me,Be,0,0)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,ge.width,ge.height,te.depth,me,ge.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,W,Ce,ge.width,ge.height,te.depth,0,ge.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Le?C&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,ge.width,ge.height,te.depth,me,Re,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,W,Ce,ge.width,ge.height,te.depth,0,me,Re,ge.data)}else{Le&&Ke&&t.texStorage2D(i.TEXTURE_2D,de,Ce,Fe[0].width,Fe[0].height);for(let W=0,j=Fe.length;W<j;W++)ge=Fe[W],_.format!==Bt?me!==null?Le?C&&t.compressedTexSubImage2D(i.TEXTURE_2D,W,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,W,Ce,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Le?C&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,ge.width,ge.height,me,Re,ge.data):t.texImage2D(i.TEXTURE_2D,W,Ce,ge.width,ge.height,0,me,Re,ge.data)}else if(_.isDataArrayTexture)if(Le){if(Ke&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,Ce,te.width,te.height,te.depth),C)if(_.layerUpdates.size>0){const W=ro(te.width,te.height,_.format,_.type);for(const j of _.layerUpdates){const ue=te.data.subarray(j*W/te.data.BYTES_PER_ELEMENT,(j+1)*W/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,j,te.width,te.height,1,me,Re,ue)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,me,Re,te.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ce,te.width,te.height,te.depth,0,me,Re,te.data);else if(_.isData3DTexture)Le?(Ke&&t.texStorage3D(i.TEXTURE_3D,de,Ce,te.width,te.height,te.depth),C&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,me,Re,te.data)):t.texImage3D(i.TEXTURE_3D,0,Ce,te.width,te.height,te.depth,0,me,Re,te.data);else if(_.isFramebufferTexture){if(Ke)if(Le)t.texStorage2D(i.TEXTURE_2D,de,Ce,te.width,te.height);else{let W=te.width,j=te.height;for(let ue=0;ue<de;ue++)t.texImage2D(i.TEXTURE_2D,ue,Ce,W,j,0,me,Re,null),W>>=1,j>>=1}}else if(Fe.length>0){if(Le&&Ke){const W=Pe(Fe[0]);t.texStorage2D(i.TEXTURE_2D,de,Ce,W.width,W.height)}for(let W=0,j=Fe.length;W<j;W++)ge=Fe[W],Le?C&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,me,Re,ge):t.texImage2D(i.TEXTURE_2D,W,Ce,me,Re,ge);_.generateMipmaps=!1}else if(Le){if(Ke){const W=Pe(te);t.texStorage2D(i.TEXTURE_2D,de,Ce,W.width,W.height)}C&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,Re,te)}else t.texImage2D(i.TEXTURE_2D,0,Ce,me,Re,te);d(_)&&h(Y),Me.__version=q.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function G(y,_,U){if(_.image.length!==6)return;const Y=ie(y,_),Z=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+U);const q=n.get(Z);if(Z.version!==q.__version||Y===!0){t.activeTexture(i.TEXTURE0+U);const Me=Xe.getPrimaries(Xe.workingColorSpace),oe=_.colorSpace===hn?null:Xe.getPrimaries(_.colorSpace),pe=_.colorSpace===hn||Me===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const He=_.isCompressedTexture||_.image[0].isCompressedTexture,te=_.image[0]&&_.image[0].isDataTexture,me=[];for(let j=0;j<6;j++)!He&&!te?me[j]=M(_.image[j],!0,r.maxCubemapSize):me[j]=te?_.image[j].image:_.image[j],me[j]=$e(_,me[j]);const Re=me[0],Ce=s.convert(_.format,_.colorSpace),ge=s.convert(_.type),Fe=b(_.internalFormat,Ce,ge,_.colorSpace),Le=_.isVideoTexture!==!0,Ke=q.__version===void 0||Y===!0,C=Z.dataReady;let de=T(_,Re);D(i.TEXTURE_CUBE_MAP,_);let W;if(He){Le&&Ke&&t.texStorage2D(i.TEXTURE_CUBE_MAP,de,Fe,Re.width,Re.height);for(let j=0;j<6;j++){W=me[j].mipmaps;for(let ue=0;ue<W.length;ue++){const fe=W[ue];_.format!==Bt?Ce!==null?Le?C&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,0,0,fe.width,fe.height,Ce,fe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,Fe,fe.width,fe.height,0,fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Le?C&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,0,0,fe.width,fe.height,Ce,ge,fe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,Fe,fe.width,fe.height,0,Ce,ge,fe.data)}}}else{if(W=_.mipmaps,Le&&Ke){W.length>0&&de++;const j=Pe(me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,de,Fe,j.width,j.height)}for(let j=0;j<6;j++)if(te){Le?C&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,me[j].width,me[j].height,Ce,ge,me[j].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Fe,me[j].width,me[j].height,0,Ce,ge,me[j].data);for(let ue=0;ue<W.length;ue++){const Be=W[ue].image[j].image;Le?C&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,0,0,Be.width,Be.height,Ce,ge,Be.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,Fe,Be.width,Be.height,0,Ce,ge,Be.data)}}else{Le?C&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Ce,ge,me[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Fe,Ce,ge,me[j]);for(let ue=0;ue<W.length;ue++){const fe=W[ue];Le?C&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,0,0,Ce,ge,fe.image[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,Fe,Ce,ge,fe.image[j])}}}d(_)&&h(i.TEXTURE_CUBE_MAP),q.__version=Z.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function K(y,_,U,Y,Z,q){const Me=s.convert(U.format,U.colorSpace),oe=s.convert(U.type),pe=b(U.internalFormat,Me,oe,U.colorSpace);if(!n.get(_).__hasExternalTextures){const te=Math.max(1,_.width>>q),me=Math.max(1,_.height>>q);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,q,pe,te,me,_.depth,0,Me,oe,null):t.texImage2D(Z,q,pe,te,me,0,Me,oe,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),ze(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,Z,n.get(U).__webglTexture,0,Ne(_)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,Z,n.get(U).__webglTexture,q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ce(y,_,U){if(i.bindRenderbuffer(i.RENDERBUFFER,y),_.depthBuffer){const Y=_.depthTexture,Z=Y&&Y.isDepthTexture?Y.type:null,q=E(_.stencilBuffer,Z),Me=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=Ne(_);ze(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,oe,q,_.width,_.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,oe,q,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,q,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Me,i.RENDERBUFFER,y)}else{const Y=_.textures;for(let Z=0;Z<Y.length;Z++){const q=Y[Z],Me=s.convert(q.format,q.colorSpace),oe=s.convert(q.type),pe=b(q.internalFormat,Me,oe,q.colorSpace),He=Ne(_);U&&ze(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,He,pe,_.width,_.height):ze(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,He,pe,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,pe,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ee(y,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),X(_.depthTexture,0);const Y=n.get(_.depthTexture).__webglTexture,Z=Ne(_);if(_.depthTexture.format===jn)ze(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Y,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Y,0);else if(_.depthTexture.format===ei)ze(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Y,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function ye(y){const _=n.get(y),U=y.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==y.depthTexture){const Y=y.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),Y){const Z=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,Y.removeEventListener("dispose",Z)};Y.addEventListener("dispose",Z),_.__depthDisposeCallback=Z}_.__boundDepthTexture=Y}if(y.depthTexture&&!_.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");ee(_.__webglFramebuffer,y)}else if(U){_.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[Y]),_.__webglDepthbuffer[Y]===void 0)_.__webglDepthbuffer[Y]=i.createRenderbuffer(),ce(_.__webglDepthbuffer[Y],y,!1);else{const Z=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=_.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,q)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),ce(_.__webglDepthbuffer,y,!1);else{const Y=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Z=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Z),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,Z)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Te(y,_,U){const Y=n.get(y);_!==void 0&&K(Y.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&ye(y)}function Ie(y){const _=y.texture,U=n.get(y),Y=n.get(_);y.addEventListener("dispose",R);const Z=y.textures,q=y.isWebGLCubeRenderTarget===!0,Me=Z.length>1;if(Me||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=_.version,a.memory.textures++),q){U.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(_.mipmaps&&_.mipmaps.length>0){U.__webglFramebuffer[oe]=[];for(let pe=0;pe<_.mipmaps.length;pe++)U.__webglFramebuffer[oe][pe]=i.createFramebuffer()}else U.__webglFramebuffer[oe]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){U.__webglFramebuffer=[];for(let oe=0;oe<_.mipmaps.length;oe++)U.__webglFramebuffer[oe]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if(Me)for(let oe=0,pe=Z.length;oe<pe;oe++){const He=n.get(Z[oe]);He.__webglTexture===void 0&&(He.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&ze(y)===!1){U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){const pe=Z[oe];U.__webglColorRenderbuffer[oe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[oe]);const He=s.convert(pe.format,pe.colorSpace),te=s.convert(pe.type),me=b(pe.internalFormat,He,te,pe.colorSpace,y.isXRRenderTarget===!0),Re=Ne(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,Re,me,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,U.__webglColorRenderbuffer[oe])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),ce(U.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),D(i.TEXTURE_CUBE_MAP,_);for(let oe=0;oe<6;oe++)if(_.mipmaps&&_.mipmaps.length>0)for(let pe=0;pe<_.mipmaps.length;pe++)K(U.__webglFramebuffer[oe][pe],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,pe);else K(U.__webglFramebuffer[oe],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);d(_)&&h(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let oe=0,pe=Z.length;oe<pe;oe++){const He=Z[oe],te=n.get(He);t.bindTexture(i.TEXTURE_2D,te.__webglTexture),D(i.TEXTURE_2D,He),K(U.__webglFramebuffer,y,He,i.COLOR_ATTACHMENT0+oe,i.TEXTURE_2D,0),d(He)&&h(i.TEXTURE_2D)}t.unbindTexture()}else{let oe=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(oe=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(oe,Y.__webglTexture),D(oe,_),_.mipmaps&&_.mipmaps.length>0)for(let pe=0;pe<_.mipmaps.length;pe++)K(U.__webglFramebuffer[pe],y,_,i.COLOR_ATTACHMENT0,oe,pe);else K(U.__webglFramebuffer,y,_,i.COLOR_ATTACHMENT0,oe,0);d(_)&&h(oe),t.unbindTexture()}y.depthBuffer&&ye(y)}function Ye(y){const _=y.textures;for(let U=0,Y=_.length;U<Y;U++){const Z=_[U];if(d(Z)){const q=y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Me=n.get(Z).__webglTexture;t.bindTexture(q,Me),h(q),t.unbindTexture()}}}const Oe=[],w=[];function St(y){if(y.samples>0){if(ze(y)===!1){const _=y.textures,U=y.width,Y=y.height;let Z=i.COLOR_BUFFER_BIT;const q=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Me=n.get(y),oe=_.length>1;if(oe)for(let pe=0;pe<_.length;pe++)t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let pe=0;pe<_.length;pe++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),oe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Me.__webglColorRenderbuffer[pe]);const He=n.get(_[pe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,He,0)}i.blitFramebuffer(0,0,U,Y,0,0,U,Y,Z,i.NEAREST),l===!0&&(Oe.length=0,w.length=0,Oe.push(i.COLOR_ATTACHMENT0+pe),y.depthBuffer&&y.resolveDepthBuffer===!1&&(Oe.push(q),w.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,w)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Oe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),oe)for(let pe=0;pe<_.length;pe++){t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,Me.__webglColorRenderbuffer[pe]);const He=n.get(_[pe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,He,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const _=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Ne(y){return Math.min(r.maxSamples,y.samples)}function ze(y){const _=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function we(y){const _=a.render.frame;u.get(y)!==_&&(u.set(y,_),y.update())}function $e(y,_){const U=y.colorSpace,Y=y.format,Z=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||U!==mn&&U!==hn&&(Xe.getTransfer(U)===Je?(Y!==Bt||Z!==tn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),_}function Pe(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=S,this.setTexture2D=X,this.setTexture2DArray=$,this.setTexture3D=H,this.setTextureCube=J,this.rebindTextures=Te,this.setupRenderTarget=Ie,this.updateRenderTargetMipmap=Ye,this.updateMultisampleRenderTarget=St,this.setupDepthRenderbuffer=ye,this.setupFrameBufferTexture=K,this.useMultisampledRTT=ze}function sp(i,e){function t(n,r=hn){let s;const a=Xe.getTransfer(r);if(n===tn)return i.UNSIGNED_BYTE;if(n===qs)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ys)return i.UNSIGNED_SHORT_5_5_5_1;if(n===wo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===bo)return i.BYTE;if(n===Ao)return i.SHORT;if(n===mi)return i.UNSIGNED_SHORT;if(n===Xs)return i.INT;if(n===Cn)return i.UNSIGNED_INT;if(n===Zt)return i.FLOAT;if(n===gi)return i.HALF_FLOAT;if(n===Ro)return i.ALPHA;if(n===Co)return i.RGB;if(n===Bt)return i.RGBA;if(n===Po)return i.LUMINANCE;if(n===Lo)return i.LUMINANCE_ALPHA;if(n===jn)return i.DEPTH_COMPONENT;if(n===ei)return i.DEPTH_STENCIL;if(n===Do)return i.RED;if(n===js)return i.RED_INTEGER;if(n===Uo)return i.RG;if(n===Ks)return i.RG_INTEGER;if(n===$s)return i.RGBA_INTEGER;if(n===Zi||n===Ji||n===Qi||n===er)if(a===Je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Zi)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ji)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Qi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===er)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Zi)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ji)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Qi)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===er)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===fs||n===ps||n===ms||n===gs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===fs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ps)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ms)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===gs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===_s||n===vs||n===xs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===_s||n===vs)return a===Je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===xs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ms||n===Ss||n===Es||n===ys||n===Ts||n===bs||n===As||n===ws||n===Rs||n===Cs||n===Ps||n===Ls||n===Ds||n===Us)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ms)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ss)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Es)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ys)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ts)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===bs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===As)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ws)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Rs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Cs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ps)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ls)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ds)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Us)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===tr||n===Is||n===Ns)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===tr)return a===Je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Is)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ns)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Io||n===Fs||n===Os||n===Bs)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===tr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Fs)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Os)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Bs)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Qn?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class ap extends Nt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class qi extends ft{constructor(){super(),this.isGroup=!0,this.type="Group"}}const op={type:"move"};class Jr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new qi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new qi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new qi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const M of e.hand.values()){const d=t.getJointPose(M,n),h=this._getHandJoint(c,M);d!==null&&(h.matrix.fromArray(d.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=d.radius),h.visible=d!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],p=u.position.distanceTo(f.position),m=.02,v=.005;c.inputState.pinching&&p>m+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(op)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new qi;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const lp=`
void main() {
...
`,ea=({mode:i="fullscreen",className:e=""})=>{const{engine:t,theme:n}=wt(),r=nt.useRef(null),s=nt.useRef(null),[a,o]=nt.useState(0);nt.useEffect(()=>{if(!r.current||!t)return;const c=r.current,u=i==="fullscreen";try{const f=new mp({antialias:!0,alpha:!0,powerPreference:"high-performance"});f.setPixelRatio(Math.min(window.devicePixelRatio,2));const p=()=>{const z=u?window.innerWidth:c.clientWidth,B=u?window.innerHeight:c.clientHeight;return f.setSize(z,B),{width:z,height:B}},m=p();f.setClearColor(0,0),c.appendChild(f.domElement),s.current=f;const v=new gp,M=new Ko(-m.width/2,m.width/2,m.height/2,-m.height/2,.1,1e3);M.position.z=10;const d=new zt,h=new kt({vertexShader:Ep,fragmentShader:yp,transparent:!0,blending:rr,depthWrite:!1,uniforms:{uTime:{value:0},uAccent:{value:new Ge(n==="mission"?15907131:3463423)},uGlowIntensity:{value:2.5},uSize:{value:u?10:6}}}),b=new Sp(d,h);v.add(b);const E=new zt,T=new kt({vertexShader:Tp,fragmentShader:bp,transparent:!0,blending:rr,depthWrite:!1,uniforms:{uTime:{value:0},uAccent:{value:new Ge(n==="mission"?15907131:3463423)}}}),k=new xp(E,T);v.add(k);let R=0,A=performance.now();const O=t.subscribe(z=>{const{nodes:B,edges:X,activeEdges:$}=z,H=f.getSize(new je),J=new Float32Array(B.length*3),V=new Float32Array(B.length);B.forEach((ie,_e)=>{J[_e*3]=ie.position[0]-H.x/2,J[_e*3+1]=ie.position[1]-H.y/2,J[_e*3+2]=ie.position[2],V[_e]=ie.energy}),d.setAttribute("position",new vt(J,3)),d.setAttribute("aEnergy",new vt(V,1));const se=new Float32Array(X.length*6),le=new Float32Array(X.length*2);X.forEach((ie,_e)=>{const G=B[ie.from],K=B[ie.to];if(G&&K){const ce=_e*6;se[ce]=G.position[0]-H.x/2,se[ce+1]=G.position[1]-H.y/2,se[ce+2]=G.position[2],se[ce+3]=K.position[0]-H.x/2,se[ce+4]=K.position[1]-H.y/2,se[ce+5]=K.position[2];const ee=[ie.from,ie.to].sort((Te,Ie)=>Te-Ie).join("-"),ye=$.has(ee)?1:0;le[_e*2]=ye,le[_e*2+1]=ye}}),E.setAttribute("position",new vt(se,3)),E.setAttribute("aActive",new vt(le,1)),h.uniforms.uTime.value=performance.now()*.001,T.uniforms.uTime.value=performance.now()*.001,f.render(v,M),R++;const D=performance.now();D-A>1e3&&(o(R),R=0,A=D)}),Q=()=>{const z=p();M.left=-z.width/2,M.right=z.width/2,M.top=z.height/2,M.bottom=-z.height/2,M.updateProjectionMatrix()},g=new ResizeObserver(()=>{Q()});u?window.addEventListener("resize",Q):g.observe(c);const S=z=>{t.emitPulse(z.clientX,z.clientY,1.5)};return window.addEventListener("click",S),()=>{if(O(),window.removeEventListener("resize",Q),window.removeEventListener("click",S),g.disconnect(),d.dispose(),h.dispose(),E.dispose(),T.dispose(),s.current){s.current.forceContextLoss(),s.current.dispose();const z=s.current.domElement;z&&z.parentNode&&z.parentNode.removeChild(z)}}}catch(f){return console.warn("WebGL initialization failed, falling back to basic background:",f),()=>{}}},[t,n,i]);const l=i==="fullscreen"?"fixed inset-0 -z-10 bg-[#020202] pointer-events-none":"relative w-full h-full min-h-[300px] overflow-hidden rounded-xl border border-white/5 jk-glass pointer-events-none";return re.jsxs("div",{ref:r,className:`${l} ${e}`,children:[re.jsx("div",{className:"absolute inset-0 opacity-[0.03] pointer-events-none bg-[url('/noise.svg')]"}),i==="fullscreen"&&re.jsxs("div",{className:"absolute top-4 right-6 font-mono text-[9px] tracking-widest text-neo-accent opacity-30 select-none",children:["SYSTEM_LOAD: ",a," FPS // ",n.toUpperCase(),"_MODE"]})]})},Ap=({children:i,showScanlines:e=!0})=>(wt(),re.jsxs("div",{className:"jk-layout-v2 relative min-h-screen bg-transparent text-white font-outfit selection:bg-neo-accent selection:text-black",children:[re.jsx(ea,{}),re.jsx("div",{className:"fixed inset-0 bg-black/40 pointer-events-none z-0"}),e&&re.jsx("div",{className:"jk-scanline"}),re.jsx("div",{className:"fixed inset-0 pointer-events-none border-[1px] border-white/5 z-[99]"}),re.jsx("div",{className:"relative z-10",children:i})]})),tl=({children:i,showScanlines:e=!0})=>re.jsx(Vs,{children:re.jsx(Ap,{showScanlines:e,children:i})}),wp=Object.freeze(Object.defineProperty({__proto__:null,NeoBadge:mo,NeoButton:fr,NeoCard:fo,NeoGrid:go,NeoInput:po,NeoLayout:tl,NeoModal:_o,NeoPanel:vo,NeoTable:xo,NeoTabs:Mo,NeoToast:So,NeuralBackground:ea,NeuralEngine:ks,SystemContext:dr,SystemProvider:Vs,useSystem:wt},Symbol.toStringTag,{value:"Module"}));exports.NeoBadge=mo;exports.NeoButton=fr;exports.NeoCard=fo;exports.NeoGrid=go;exports.NeoInput=po;exports.NeoLayout=tl;exports.NeoModal=_o;exports.NeoPanel=vo;exports.NeoTable=xo;exports.NeoTabs=Mo;exports.NeoToast=So;exports.NeuralBackground=ea;exports.NeuralEngine=ks;exports.SystemContext=dr;exports.SystemProvider=Vs;exports.cx=At;exports.index=wp;exports.useSystem=wt;
//# sourceMappingURL=index-Chw0T0TI.cjs.map
